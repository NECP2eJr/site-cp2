    ...
    if ($_POST['submit']) {
		if ($nome != '' && $mensagem != '' && $assunto != '' && $email  != '' ) {
			if (mail ($to, $subject,$message, $headers) && mail($to2, $subject, $message2, $from)) {
				echo("<script type='text/javascript'> alert('Email foi enviado com Sucesso'); location.href='http://cp2ejr.com.br/TESTANO/EMPRESA/contato.html';</script>");
			} else {
